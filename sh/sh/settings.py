...
SECRET_KEY = 'django-insecure-)xq2ws9xql!owra&e#(jro0*b@a*zy1u-*9fgc&!pcprchb-@k'
...
#for Templates we have DIR:[DIRS': [os.path.join(BASE_DIR,'templates/'),],]
#but here we have from the first lesson below one , so far use it then 
#have a look at what happen,if we need we will change it to the
